...
describe('Footer.vue', () => {
    ...
    it('Component has one active filter', () => {
        ...
        const activeTabButton = wrapper.findAllComponents(TabButton).wrappers.find((el) => el.props().title === 'All');
    ...
    it('Component calls mutation changeTabStatus', () => {
        ...
        wrapper.findAllComponents(TabButton).wrappers.find((el) => el.props().title === 'Completed').trigger('click');
